...
bool TileMapGeometry::Init()
{
	...
	m_shaderProgram.CreateFromMemories(simpleTextureVertexShaderSource, simpleTextureFragmentShaderSource);
#else
	...
	//m_shaderProgram.CreateFromMemories(simpleVertexShaderSource, simpleFragmentShaderSource);
#endif
