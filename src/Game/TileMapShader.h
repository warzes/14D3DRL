...
constexpr const char* simpleTextureVertexShaderSource = R"(
#version 330 core
...
constexpr const char* simpleTextureFragmentShaderSource = R"(
#version 330 core
...
constexpr const char* simpleVertexShaderSource = R"(
#version 330 core
...
constexpr const char* simpleFragmentShaderSource = R"(
#version 330 core
